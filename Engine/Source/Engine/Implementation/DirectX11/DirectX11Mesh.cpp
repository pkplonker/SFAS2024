...
DirectX11Mesh::DirectX11Mesh(std::string path, ID3D11DeviceContext* ContextIn, ID3D11Buffer* VertexBufferIn,
	...
	vertexCount(vertexCountIn), indexCount(indexCount), IMeshRenderable(path)
{
}
